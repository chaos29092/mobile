                                ...
                                <fieldset class="form-horizontal">
                                    ...
                                    <div class="form-group"><label class="col-sm-2 control-label">分类简介(不超过20字):</label>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-2"><input name="big_pic" type="file" /></div>
                                         @if($category['big_pic'])
                                             <img class="col-sm-2" src="{{$category->big_pic}}" alt="">
                                         @endif
                                     </div>

                                        <div class="form-group">
                                         <label class="col-sm-2 control-label" for="small_pic">分类小图（200*200）</label>
                                         <div class="col-sm-2"><input name="small_pic" type="file" /></div>
                                         @if($category['small_pic'])
                                             <img class="col-sm-2" src="{{$category->small_pic}}" alt="">
                                         @endif
                                     </div>
