                            ...
                            <div class="panel-body">
                                <fieldset class="form-horizontal">
                                    <form action="/admin/categories" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-10"><input type="text" class="form-control" placeholder="Category name" name="name" ></div>
                                    </div>
                                    <div class="form-group"><label class="col-sm-2 control-label">分类简介(不超过20字):</label>
                                     ...
                                     <div class="form-group">
                                         <label class="col-sm-2 control-label" for="big_pic">分类主图（650*200）</label>
                                         <div class="col-sm-10"><input name="big_pic" type="file" /></div>
                                     </div>

                                        <div class="form-group">
                                         <label class="col-sm-2 control-label" for="small_pic">分类小图（200*200）</label>
                                         <div class="col-sm-10"><input name="small_pic" type="file" /></div>
                                     </div>
